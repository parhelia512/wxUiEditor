...
namespace GenEnum
{
    ...
    enum PropName
    {
        ...
        prop_folder_fortran_combined_file,
        ...
        prop_kwxFortran_version,

        prop_folder_go_combined_file,
        prop_folder_go_output_folder,
        prop_go_conditional,
        prop_go_file,
        prop_go_inherit_name,
        prop_go_insert,
        prop_go_line_length,
        prop_go_output_folder,
        prop_go_project_preamble,
        prop_kwxGO_version,

        prop_folder_julia_combined_file,
        prop_folder_julia_output_folder,
        prop_julia_conditional,
        prop_julia_file,
        prop_julia_inherit_name,
        prop_julia_insert,
        prop_julia_line_length,
        prop_julia_output_folder,
        prop_julia_project_preamble,
        prop_kwxJulia_version,
